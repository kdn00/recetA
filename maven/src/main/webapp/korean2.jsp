                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4 text-center">
                            <a href="RecipedetailpageCon?b_code=4">
                            <img src="./img/aaa.jpg" alt="" width="311" height="289"><br>
                            <button type="button" class="btn btn-outline-link m-2"><h6>레시피명1</h6></button>
                            </a>
                        </div>
                    </div>
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4 text-center">
                            <a href="RecipedetailpageCon?b_code=77">
                            <img src="./img/aaa.jpg" alt="" width="311" height="289"><br>
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4 text-center">
                            <a href="RecipedetailpageCon?b_code=66">
                            <img src="./img/aaa.jpg" alt="" width="311" height="289"><br>                            
                            <button type="button" class="btn btn-outline-link m-2"><h6>레시피명</h6></button>
                            </a>
                        </div>
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4 text-center">
                            <a href="RecipedetailpageCon?b_code=55">
                            <img src="./img/aaa.jpg" alt="" width="311" height="289"><br>                            
                            <button type="button" class="btn btn-outline-link m-2"><h6>레시피명</h6></button>
                            </a>
                        </div>
