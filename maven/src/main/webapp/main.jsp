    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="main.html" class="navbar-brand mx-4 mb-3 navbar bg-danger row">
                ...
                <div class="navbar-nav w-100">
                    <a href="main.html" class="nav-item nav-link active"><i class="bi bi-egg-fried"></i>HOME</a>
                    
                    <a href="widget.html" class="nav-item nav-link"><i class="bi bi-cup"></i>레시피</a>
                    <a href="blank.html" class="nav-item nav-link"><i class="bi bi-cup-straw"></i>공지사항</a>
